      ...
      <PageLayout>
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="max-w-4xl space-y-6 text-white/70" style={{ fontFamily: "var(--font-poppins)" }}>
            <p className="text-lg">
              This page will contain detailed information about our model evaluation metrics, 
              including accuracy, precision, recall, F1-scores, and clinical validation results.
            </p>
            <p className="text-lg">
              Content coming soon...
            </p>
